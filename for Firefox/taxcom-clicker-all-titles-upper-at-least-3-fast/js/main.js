...
function main() {
	...
	const
        PLUGIN_VERSION = 'taxcom-clicker-all-titles-upper-at-least-3-fast',
        
        TITLE_T5 = 'т5 - показания одометра при заезде',
        
        URL_AT_SIGNING = 'https://epl.taxcom.ru/at_signing/',
        URL_START = 'https://epl.taxcom.ru/at_signing/?start-taxcom-clicker-all-titles-upper-at-least-3-fast';
        
        MILEAGE_PATTERN = '^показания одометра: [0-9]+$',
        
		URL_PATTERN_MAIN = '^https://epl.taxcom.ru/$', // тут жму на кнопку "Подписать"
		URL_PATTERN_START_PLUGIN = '^https://epl.taxcom.ru/at_signing/\\?start-taxcom-clicker-all-titles-upper-at-least-3-fast$', // запуск плагина
    ...
    function checkPluginVersion() {
        ...
        if(res) {
            let
                ...
                fragment = create('<div>Плагин: taxcom-clicker-all-titles-upper-at-least-3-fast. Кликает верхний ЭПЛ из списка на странице /at_signing. Обрабатывает зависание во время подписания.</div>');
