...
class Clicker {
    ...
    checkPluginVersion() {
        ...
        if(res) {
            let
                fragment = create('<div>Плагин: t5-pagination-fast. Обрабатывает ЭПЛ на сайте epl.taxcom.ru. Обрабатывает все ЭПЛ на странице /at_signing, с пагинацией, запоминает номер страницы.</div>');
