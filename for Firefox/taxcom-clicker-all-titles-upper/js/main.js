...
function main() {
    ...
    function checkPluginVersion() {
        ...
        if(res) {
            let
                ...
                fragment = create('<div>&#128314; ВЕРХНИЙ, если более 2 ЭПЛ на странице: перехвачено: '+ num +'</div>');
    ...
    function actionAtSigning() {
        ...
        if(links.length < 3) {
            ...
            setTimeout(()=>{ links[0].click(); }, DELAY_LINK_CLICK_MS);
        }
    }
